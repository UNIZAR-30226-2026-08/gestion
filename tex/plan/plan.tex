...
contenedores Docker que desplieguen un sistema operativo Debian o Alpine Linux;
...
el código está escrito en inglés (nombres de variables y comentarios pertinentes),
utilizando el nombrado con camelCase para las clases y el resto de variables 
con snake\_case.
Para la generación de la documentación se 
% TODO mencionar qué herramientas lo pueden sacar de forma automática
...
% TODO diagramas: poner las foticos de los diagramas en sí.
El sistema ofrece un cliente web y un cliente escritorio, para los que
utiliza una arquitectura en 4 y 3 niveles, como puede verse en la
...
varios contenedores, sin perjuicio a que se pudiera realizar en varias
máquinas distintas cada contenedor, según lo especificado en el 
diagrama de despliegue de la Figura \ref{fig:despliegue}.
El diagrama de componentes de la Figura \ref{fig:componentes} nos aporta
la semántica de las comunicaciones entre los elementos desplegados. 
La comunicación se realiza a través de web sockets para el juego y de
API Rest para el resto de la aplicación. 
Esto simplifica y generaliza los diagramas de
secuencia y comunicación. Destacamos los diagramas de de las Figuras %TODO
...
fase de gestión, en la que pueden realizarse opcionalmente y en cualquier orden
el resto de operaciones del juego (intercambio, y administrar propiedades:
construcción, derruir casas e hipotecar).
...
La decisión sobre el diseño de la arquitectura viene directamente motivadas
...
Sobre los protocolos de comunicación entre los componentes del sistema,
...
frontend).
% TODO poner bien los nombritos cuando estén los diagramas.
