...
durante días designados para la conciliación entre backend y frontend, como
...
Para la \textbf{comunicación interna}, se han creado grupos de WhatsApp por módulo
...
\begin{figure}[hbtp]
		...
		\caption{Diagramas de la arquitectura a alto nivel.}
...
más general (la hipóteca), en la que proponente y receptor pueden ser 
distintos. 
...
backend, el cliente web y el cliente escritorio. La estructura de
...
\ref{fig:modbackend}, \ref{fig:modweb} y \ref{fig:modesc}, respectivamente
...
a usar en el proyecto. Las posibles candidatas consideradas son todas
...
en primer lugar a web, ya que la plataforma es más restrictiva que
...
\ref{fig:gantt}, y los esfuerzos realizados están en torno al 33\% del
proyecto, adecuado para el momento en el que nos encontramos. % TODO 
...
corresponden con las tareas que tenían asignadas en un principio, están
equilibradas teniendo en cuenta las actividades realizadas hasta la
fecha y suponen en torno a un \% del proyecto.
...
\begin{figure}[hbtp]
		...
		\caption{Diagrama de estados de la fase de Subasta de un turno del juego Magnates.}
		\label{fig:subasta}
\end{figure}
